({
    ...
    submitInv : function(component, event, helper) {  
        ...
        calculateGrandTotal : function(component, event, helper){
            ...
            var recordType = component.get("v.salesTaxConfig")
            console.log('salesTaxObject',RecordTypeName);
            var salesTax = 0.00;
            ...
            if(salesTaxObject != null && typeof salesTaxObject != "undefined"){
                ...
                if(typeof state != "undefined"){
                    ...
                    if(typeof salesTaxSetting != "undefined"){
                        if(recordType == 'Web Invoices' && salesTaxSetting.BOATBUILDING__Web_Invoice_Taxable__c) {
