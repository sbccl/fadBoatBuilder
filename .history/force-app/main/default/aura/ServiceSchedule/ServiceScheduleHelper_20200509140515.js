({
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventResize: function(arg) {
            ...
            //2020-04-22T12:30:00
            var startDt = arg.event._instance.range.start;
            var startDateT = startDt.getYear()+'-'+startDt.getMonth()+'-'+startDt.getDate()+'T'+startDt.getHours()+':'+startDt.getMinutes()+':00';
            console.log('>>>startDateT: ',startDateT);
            var endDt = arg.event._instance.range.end;
            var endDateT = endDt.getYear()+'-'+endDt.getMonth()+'-'+endDt.getDate()+'T'+endDt.getHours()+':'+endDt.getMinutes()+':00';
            console.log('>>>endDateT: ',endDateT);
