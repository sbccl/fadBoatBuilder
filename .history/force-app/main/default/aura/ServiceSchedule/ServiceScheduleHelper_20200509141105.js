({
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventDrop: function(arg) {
            ...
            var endDateT = arg.event.end.getYear()+'-'+arg.event.end.getMonth()+'-'+arg.event.end.getDate()+'T'+arg.event.end.getHours()+':'+arg.event.end.getMinutes()+':00';
        ...
        eventResize: function(arg) {
            ...
            var startDateT = arg.event.start.getFullYear()+'-'+arg.event.start.getMonth()+'-'+arg.event.start.getDate()+'T'+arg.event.start.getHours()+':'+arg.event.start.getMinutes()+':00';
            console.log('>>>startDateT: ',startDateT);
            var endDateT = arg.event.end.getFullYear()+'-'+arg.event.end.getMonth()+'-'+arg.event.end.getDate()+'T'+arg.event.end.getHours()+':'+arg.event.end.getMinutes()+':00';
            console.log('>>>endDateT: ',endDateT);
