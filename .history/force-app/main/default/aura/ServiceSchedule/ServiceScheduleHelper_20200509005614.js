({
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventResize: function(arg) {
            ...
            console.log(">>>>1>>: ",arg.event._instance.range.end.getDate());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toLocaleDateString());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toLocaleString());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toLocaleTimeString());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toString());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toTimeString());
            console.log(">>>>1>>: ",arg.event._instance.range.end.toUTCString());
            console.log(">>>>2: ",arg.event.end);
        } 
    });
