...
(function (global, factory) {
    ...
    function listenBySelector(container, eventType, selector, handler) {
        function realHandler(ev) {
            var matchedChild = ev.target.closest(selector);
    ...
    var DateComponent = /** @class */ (function (_super) {
        ...
        DateComponent.prototype.isValidSegDownEl = function (el) {
            return !this.props.eventDrag && // HACK
                ...
                !el.closest('.fc-mirror') &&
                (this.isPopover() || !this.isInPopover(el));
            // ^above line ensures we don't detect a seg interaction within a nested component.
            // it's a HACK because it only supports a popover as the nested component.
        };
        DateComponent.prototype.isValidDateDownEl = function (el) {
            var segEl = el.closest(this.fgSegSelector);
            return (!segEl || segEl.classList.contains('fc-mirror')) &&
                !el.closest('.fc-more') && // a "more.." link
                !el.closest('a[data-goto]') && // a clickable nav link
                !this.isInPopover(el);
        };
        ...
        DateComponent.prototype.isInPopover = function (el) {
            return Boolean(el.closest('.fc-popover') );
        };
        ...
        function EventClicking(settings) {
            ...
            _this.handleSegClick = function (ev, segEl) {
                ...
                if (seg && // might be the <div> surrounding the more link
                    ...
                    var hasUrlContainer = ev.target.closest('.fc-has-url');
