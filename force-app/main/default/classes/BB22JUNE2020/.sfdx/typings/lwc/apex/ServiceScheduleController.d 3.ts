declare module "@salesforce/apex/ServiceScheduleController.getUsersSLocation" {
  export default function getUsersSLocation(): Promise<any>;
}
declare module "@salesforce/apex/ServiceScheduleController.getUserList" {
  export default function getUserList(param: {sLoaction: any}): Promise<any>;
}
declare module "@salesforce/apex/ServiceScheduleController.getUserListSLGroup" {
  export default function getUserListSLGroup(param: {sLoaction: any}): Promise<any>;
}
declare module "@salesforce/apex/ServiceScheduleController.getrecordType" {
